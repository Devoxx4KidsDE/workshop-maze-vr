...
function start () {
    ...
    maze.addWall(Wall.create({x: 3, z: 0, orientation: 'right'}));
    maze.addWall(Wall.create({x: 4, z: 1, orientation: 'right'}));
    maze.addWall(Wall.create({x: 4, z: 1, orientation: 'right'}));
    maze.addWall(Wall.create({x: 4, z: 1, orientation: 'back'}));
    maze.addWall(Wall.create({x: 4, z: 3, orientation: 'back'}));
    maze.addWall(Wall.create({x: 4, z: 3, orientation: 'left'}));
    maze.addWall(Wall.create({x: 3, z: 2, orientation: 'back'}));
    maze.addWall(Wall.create({x: 3, z: 3, orientation: 'back'}));
    maze.addWall(Wall.create({x: 3, z: 4, orientation: 'back'}));
    maze.addWall(Wall.create({x: 2, z: 2, orientation: 'back'}));
    maze.addWall(Wall.create({x: 2, z: 3, orientation: 'back'}));
    maze.addWall(Wall.create({x: 2, z: 4, orientation: 'back'}));
    maze.addWall(Wall.create({x: 0, z: 1, orientation: 'right'}));
